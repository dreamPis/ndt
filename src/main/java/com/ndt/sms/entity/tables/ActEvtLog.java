...
public class ActEvtLog extends TableImpl<ActEvtLogRecord> {
    ...
    /**
     * The column <code>ndt.act_evt_log.proc_def_id_</code>.
     */
    ...
    /**
     * The column <code>ndt.act_evt_log.proc_inst_id_</code>.
     */
    ...
    /**
     * The column <code>ndt.act_evt_log.execution_id_</code>.
     */
    ...
    /**
     * The column <code>ndt.act_evt_log.task_id_</code>.
     */
    public final TableField<ActEvtLogRecord, String> TASK_ID_ = createField("task_id_", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>ndt.act_evt_log.time_stamp_</code>.
     */
    public final TableField<ActEvtLogRecord, Timestamp> TIME_STAMP_ = createField("time_stamp_", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");

    /**
     * The column <code>ndt.act_evt_log.user_id_</code>.
     */
    public final TableField<ActEvtLogRecord, String> USER_ID_ = createField("user_id_", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>ndt.act_evt_log.data_</code>.
     */
    public final TableField<ActEvtLogRecord, byte[]> DATA_ = createField("data_", org.jooq.impl.SQLDataType.BLOB, this, "");

    /**
     * The column <code>ndt.act_evt_log.lock_owner_</code>.
     */
    ...
    /**
     * The column <code>ndt.act_evt_log.lock_time_</code>.
     */
    public final TableField<ActEvtLogRecord, Timestamp> LOCK_TIME_ = createField("lock_time_", org.jooq.impl.SQLDataType.TIMESTAMP, this, "");

    /**
     * The column <code>ndt.act_evt_log.is_processed_</code>.
     */
    ...
    /**
     * Create a <code>ndt.act_evt_log</code> table reference
     */
    public ActEvtLog() {
    ...
    /**
     * Create an aliased <code>ndt.act_evt_log</code> table reference
     */
