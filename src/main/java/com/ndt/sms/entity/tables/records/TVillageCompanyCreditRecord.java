...
public class TVillageCompanyCreditRecord extends UpdatableRecordImpl<TVillageCompanyCreditRecord> implements Record9<BigDecimal, BigDecimal, String, String, Short, BigDecimal, Timestamp, BigDecimal, Timestamp> {

    private static final long serialVersionUID = 1007226244;
     ...
     */
    @Override
    public TVillageCompanyCreditRecord values(BigDecimal value1, BigDecimal value2, String value3, String value4, Short value5, BigDecimal value6, Timestamp value7, BigDecimal value8, Timestamp value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TVillageCompanyCreditRecord(BigDecimal id, BigDecimal villageCompanyInfoId, String situation, String year, Short status, BigDecimal createUser, Timestamp createTime, BigDecimal updateUser, Timestamp updateTime) {
        super(TVillageCompanyCredit.T_VILLAGE_COMPANY_CREDIT);
