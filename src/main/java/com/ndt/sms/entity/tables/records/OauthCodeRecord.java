...
public class OauthCodeRecord extends TableRecordImpl<OauthCodeRecord> implements Record2<String, byte[]> {
     ...
     */
    public OauthCodeRecord setCode(String value) {
        set(0, value);
        return this;
    }

    /**
     * Getter for <code>ndt.oauth_code.code</code>.
     */
    ...
    /**
     * Setter for <code>ndt.oauth_code.authentication</code>.
     */
    public OauthCodeRecord setAuthentication(byte... value) {
        set(1, value);
        return this;
    }

    /**
     * Getter for <code>ndt.oauth_code.authentication</code>.
     */
