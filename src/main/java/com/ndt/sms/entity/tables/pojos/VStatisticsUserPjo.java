...
public class VStatisticsUserPjo implements Serializable {

    private static final long serialVersionUID = -1051353150;
    ...
    public VStatisticsUserPjo() {}

    public VStatisticsUserPjo(VStatisticsUserPjo value) {
        this.id = value.id;
        ...
        this.divisionFullName = value.divisionFullName;
        this.isBindCompany = value.isBindCompany;
    ...
    public VStatisticsUserPjo setId(BigDecimal id) {
        this.id = id;
        return this;
    }
    ...
    public VStatisticsUserPjo setLoginName(String loginName) {
        this.loginName = loginName;
        return this;
    }
    ...
    public VStatisticsUserPjo setSalt(String salt) {
        this.salt = salt;
        return this;
    }
    ...
    public VStatisticsUserPjo setPassword(String password) {
        this.password = password;
        return this;
    }
    ...
    public VStatisticsUserPjo setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public VStatisticsUserPjo setGender(Integer gender) {
        this.gender = gender;
        return this;
    }
    ...
    public VStatisticsUserPjo setMobile(String mobile) {
        this.mobile = mobile;
        return this;
    }
    ...
    public VStatisticsUserPjo setImageUrl(String imageUrl) {
        this.imageUrl = imageUrl;
        return this;
    }
    ...
    public VStatisticsUserPjo setUserType(Integer userType) {
        this.userType = userType;
        return this;
    }
    ...
    public VStatisticsUserPjo setAdminDivisionId(BigDecimal adminDivisionId) {
        this.adminDivisionId = adminDivisionId;
        return this;
    }
    ...
    public VStatisticsUserPjo setOrgId(BigDecimal orgId) {
        this.orgId = orgId;
        return this;
    }
    ...
    public VStatisticsUserPjo setUserDetailId(BigDecimal userDetailId) {
        this.userDetailId = userDetailId;
        return this;
    }
    ...
    public VStatisticsUserPjo setSubscriptionTypes(Integer... subscriptionTypes) {
        this.subscriptionTypes = subscriptionTypes;
        return this;
    }
    ...
    public VStatisticsUserPjo setAccountState(Integer accountState) {
        this.accountState = accountState;
        return this;
    }
    ...
    public VStatisticsUserPjo setStatus(Short status) {
        this.status = status;
        return this;
    }
    ...
    public VStatisticsUserPjo setCreateBy(BigDecimal createBy) {
        this.createBy = createBy;
        return this;
    }
    ...
    public VStatisticsUserPjo setCreateAt(Timestamp createAt) {
        this.createAt = createAt;
        return this;
    }
    ...
    public VStatisticsUserPjo setUpdateBy(BigDecimal updateBy) {
        this.updateBy = updateBy;
        return this;
    }
    ...
    public VStatisticsUserPjo setUpdateAt(Timestamp updateAt) {
        this.updateAt = updateAt;
        return this;
    }
    ...
    public VStatisticsUserPjo setLastLoginTime(Timestamp lastLoginTime) {
        this.lastLoginTime = lastLoginTime;
        return this;
    }
    ...
    public VStatisticsUserPjo setSourceId(Integer sourceId) {
        this.sourceId = sourceId;
        return this;
    }
    ...
    public VStatisticsUserPjo setIsFarm(Boolean isFarm) {
        this.isFarm = isFarm;
        return this;
    }
    ...
    public VStatisticsUserPjo setIsCooperation(Boolean isCooperation) {
        this.isCooperation = isCooperation;
        return this;
    }
    ...
    public VStatisticsUserPjo setIsLeadingEnterprice(Boolean isLeadingEnterprice) {
        this.isLeadingEnterprice = isLeadingEnterprice;
        return this;
    }
    ...
    public VStatisticsUserPjo setIsLargeAgriculturalFamily(Boolean isLargeAgriculturalFamily) {
        this.isLargeAgriculturalFamily = isLargeAgriculturalFamily;
        return this;
    }
    ...
    public VStatisticsUserPjo setIsMajarProject(Boolean isMajarProject) {
        this.isMajarProject = isMajarProject;
        return this;
    }
    ...
    public VStatisticsUserPjo setDivisionId(String divisionId) {
        this.divisionId = divisionId;
        return this;
    }
    ...
    public VStatisticsUserPjo setDivisionName(String divisionName) {
        this.divisionName = divisionName;
        return this;
    }
    ...
    public VStatisticsUserPjo setDivisionFullName(String divisionFullName) {
        this.divisionFullName = divisionFullName;
        return this;
    }
    ...
    public VStatisticsUserPjo setIsBindCompany(Integer isBindCompany) {
        this.isBindCompany = isBindCompany;
        return this;
    }
    ...
    public VStatisticsUserPjo setCreditType(Short creditType) {
        this.creditType = creditType;
        return this;
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("VStatisticsUserPjo (");
        ...
        sb.append(", ").append(divisionFullName);
        sb.append(", ").append(isBindCompany);
        sb.append(", ").append(creditType);
