...
import com.ndt.sms.face.jna.bean.*;
...
public interface FaceLibrary extends Library {
	...
	FaceLibrary INSTANCE = Native.load("linux_x64/libarcsoft_face_engine.so", FaceLibrary.class);
	 ...
	 * @param sdkKey
	 *            [in] 官网获取的SDKKEY
	 * @return 成功返回MOK，失败返回错误码，参考{@link com.ndt.sms.face.jna.enums.ErrorCode}
	 */
	 ...
	 *            <li>参考{@link com.ndt.sms.face.jna.enums.DetectMode}</li>
	 * @param detectFaceOrientPriority
	 *            [in]
	 *            检测脸部的角度优先值，参考：{@link com.ndt.sms.face.jna.enums.OrientPriority},
	 *            {@link com.ndt.sms.face.jna.enums.OrientCode}
