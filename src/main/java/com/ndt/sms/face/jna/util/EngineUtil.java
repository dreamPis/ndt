package com.ndt.sms.face.jna.util;
...
import com.ndt.sms.face.jna.FaceLibrary;
import com.ndt.sms.face.jna.bean.*;
import com.ndt.sms.face.jna.enums.*;
...
public class EngineUtil {
	...
	private static void activation() {
		...
		NativeLong result = INSTANCE.ASFActivation(Constants.APP_ID, Constants.SDK_KEY);
